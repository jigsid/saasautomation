      ...
      <div className="w-full max-w-6xl p-8">
        ...
        <div className="prose lg:prose-xl">
          ...
          <p>
            ...
            use of Automate&apos;s Website, located at
            https://automate69.vercel.app.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Automate if you do not agree to
            take all of the terms and conditions stated on this page.
          </p>

          <h2 className="text-2xl font-semibold mt-8">Cookies</h2>
          <p>
            We employ the use of cookies. By accessing Automate, you agreed to
            use cookies in agreement with the Automate&apos;s Privacy Policy.
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, Automate and/or its licensors own the
            intellectual property rights for all material on Automate. All
            intellectual property rights are reserved. You may access this from
            Automate for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul className="list-disc list-inside">
            <li>Republish material from Automate</li>
            <li>Sell, rent, or sub-license material from Automate</li>
            <li>Reproduce, duplicate or copy material from Automate</li>
            <li>Redistribute content from Automate</li>
          </ul>
          ...
          <ul className="list-disc list-inside">
            <li>By email: siddhammishra@gmail.com</li>
          </ul>
        </div>
      </div>
      <Footer />
