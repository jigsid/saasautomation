    ...
    <main className="flex flex-col items-center justify-center mt-20">
      ...
      <div className="w-full max-w-6xl p-8">
        ...
        <div className="prose lg:prose-xl">
          ...
          <p>
            Automate (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;)
            operates the https://automate69.vercel.app website (hereinafter
          ...
          <p>
            Service is the https://automate69.vercel.app website operated by
            Automate.
          </p>
          ...
          <p>Automate uses the collected data for various purposes:</p>
          <ul className="list-disc list-inside">
          ...
          <p>
            If you are from the European Economic Area (EEA), Automate&apos;s
            ...
            collect and the specific context in which we collect it. Automate
          ...
          <p>
            Automate will retain your Personal Data only for as long as is
            necessary for the purposes set out in this Privacy Policy. We will
            retain and use your Personal Data to the extent necessary to comply
            with our legal obligations (for example, if we are required to
            retain your data to comply with applicable laws), resolve disputes,
            and enforce our legal agreements and policies. Automate will also
          ...
          <p>
            ...
            are located outside Canada and choose to provide information to us,
            please note that we transfer the data, including Personal Data, to
            Canada and process it there. Your consent to this Privacy Policy
            followed by your submission of such information represents your
            agreement to that transfer. Automate will take all the steps
          ...
          <p>
            Automate may disclose your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <ul className="list-disc list-inside">
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Automate</li>
            <li>
          ...
          <p>
            ...
            certain data protection rights. Automate aims to take reasonable
            steps to allow you to correct, amend, delete or limit the use of
            your Personal Data. If you wish to be informed about what Personal
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              ...
              your consent at any time where Automate relied on your consent to
          ...
          <p>
            ...
            by us. Our privacy policy does not apply to third-party websites
            linked from our Service. If you click a third party link, you will
